...
namespace GRB
{
	...
	Greibach greibach(
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 1, // ошибочный сепаратор
			...
			//объявление переменных,функций,массивов
			...
			Rule::Chain(5, TS('i'), TS('a'), NS('E'), TS(';'), NS('N')),
			Rule::Chain(4, TS('i'), TS('a'), NS('E'), TS(';')),
